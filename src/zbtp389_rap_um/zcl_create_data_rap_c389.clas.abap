CLASS zcl_create_data_rap_c389 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_create_data_rap_c389 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA: lv_current_timestamp TYPE timestamp.
    GET TIME STAMP FIELD lv_current_timestamp.

    DELETE FROM zhcm_master_c389.

    MODIFY zhcm_master_c389 FROM @( VALUE #( e_number =  '00000001'
                                     e_name         = 'Lorena Perez'
