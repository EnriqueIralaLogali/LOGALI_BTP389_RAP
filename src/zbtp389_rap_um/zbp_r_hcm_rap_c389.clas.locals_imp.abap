CLASS lcl_buffer DEFINITION.
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_buffer.
             INCLUDE TYPE zhcm_master_c389 AS data.
...
CLASS lsc_ZR_HCM_RAP_C389 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZR_HCM_RAP_C389 IMPLEMENTATION.
  ...
  METHOD save.
    ...
    DATA: lt_data_created TYPE STANDARD TABLE OF zhcm_master_c389,
          lt_data_updated TYPE STANDARD TABLE OF zhcm_master_c389,
          lt_data_deleted TYPE STANDARD TABLE OF zhcm_master_c389.
...
* Create
    ...
    IF lt_data_created IS NOT INITIAL.
      INSERT zhcm_master_c389 FROM TABLE @lt_data_created.
    ENDIF.
...
* Update
    ...
    IF lt_data_updated IS NOT INITIAL.
      UPDATE zhcm_master_c389 FROM TABLE @lt_data_updated.
    ENDIF.
...
* Delete
    ...
    IF lt_data_deleted IS NOT INITIAL.
      DELETE zhcm_master_c389 FROM TABLE @lt_data_deleted.
    ENDIF.
